...
public class EditorHighLight {
  public static void main(String[] args) {
    ...
    try {
      textPane.read(new FileReader("c:\\prog.bas"), null);
    } catch (Exception e) {
...
class UnderlineHighlighter extends DefaultHighlighter {
  ...
  public static class UnderlineHighlightPainter extends
    ...
    public Shape paintLayer(Graphics g, int offs0, int offs1, Shape bounds,
     ...
     //g.drawLine(alloc.x, baseline, alloc.x + alloc.width+600, baseline);
     // g.drawLine(alloc.x, baseline + 1, alloc.x + alloc.width+600,baseline + 1);
      g.drawRect(alloc.x, 5,300,20);
      return alloc;
    }
