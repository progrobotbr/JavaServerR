...
public class trztl01_bk extends trzbase implements ActionListener, trzlocal {
	...
	public void create(ClientMain pwindow){
		try{
		...
		//JPanel pn1   = new JPanel(); //Desktop
		JPanel pn1 = pDesktop.get(GuiConstants.DESMID);
		...
		itTrz.setActionCommand(trztl01_bk.CIITRZ);
	...
	public void actionPerformed(ActionEvent ae){
		...
		}else if(s.equals(trztl01_bk.CIITRZ)){
			this.clickSearchTrz();
		}
	...
	//Eventos
	public void onLoad(){
		//Seta variáveis da classe mãe
		super.lbMsg = this.lbMsg;
		super.mProtocol = this.mProtocol;
	}
