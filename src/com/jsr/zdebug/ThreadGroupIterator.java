...
class ThreadGroupIterator implements Iterator {
    ...
    ThreadGroupIterator(Environment pEnv, List tgl) {
    	Env = pEnv;
        push(tgl);
    }

    ThreadGroupIterator(Environment pEnv, ThreadGroupReference tg) {
    	Env = pEnv;
    ...
    ThreadGroupIterator(Environment pEnv) {
        this(pEnv, pEnv.vm().topLevelThreadGroups());
    }
    ...
    static public ThreadGroupReference find(Environment pEnv, String name) {
        ThreadGroupIterator tgi = new ThreadGroupIterator(pEnv);
        while (tgi.hasNext()) {
