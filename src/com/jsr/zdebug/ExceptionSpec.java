...
class ExceptionSpec extends EventRequestSpec {
    ...
    private ExceptionSpec(Environment pEnv, messageOutput pmsgout, ReferenceTypeSpec refSpec) {
    	this(pEnv, pmsgout, refSpec, true, true);
    	this.Env = pEnv;
    	this.MessageOutput = pmsgout;
    }

    ExceptionSpec(Environment pEnv, 
    		      messageOutput pmsgout,
