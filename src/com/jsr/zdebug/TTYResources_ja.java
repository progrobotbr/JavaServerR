/*
 * @(#)TTYResources_ja.java	1.12 05/09/01
 *
 ...
 * </ol>
 *
 * @version @(#)TTYResources_ja.java	1.12 05/09/01
 */
public class TTYResources_ja extends java.util.ListResourceBundle {
    ...
    public Object[][] getContents() {
        ...
        {"Method entered:", "\u958b\u59cb\u30e1\u30bd\u30c3\u30c9: {0}.{1} "},
        {"Method exited:", "\u7d42\u4e86\u30e1\u30bd\u30c3\u30c9: {0}.{1} "},
        ...
        {"Specify kind for example methods", "\u7a2e\u985e\u3092\u6307\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044 (\u4f8b 'methods')"},
        ...
        {"Unexpected event type", "\u4e88\u671f\u3057\u306a\u3044\u7a2e\u985e\u306e\u30a4\u30d9\u30f3\u30c8\u3067\u3059"},
        {"unknown", "\u4e0d\u660e"},
