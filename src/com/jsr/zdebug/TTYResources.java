/*
 * @(#)TTYResources.java	1.14 05/09/01
 *
 ...
 * </ol>
 *
 * @version @(#)TTYResources.java	1.14 05/09/01
 */
public class TTYResources extends java.util.ListResourceBundle {

    /**
     * Returns the contents for this <code>ResourceBundle</code>.
     *
     * <p>
     *
     * @return the contents for this <code>ResourceBundle</code>.
     */
    public Object[][] getContents() {
        ...
        {"Method entered:", "Method entered: {0}.{1} "},
        {"Method exited:", "Method exited: {0}.{1} "},
        ...
        {"Specify kind for example methods", "Specify kind, for example 'methods'"},
