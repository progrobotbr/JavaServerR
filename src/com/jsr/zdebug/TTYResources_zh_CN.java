/*
 * @(#)TTYResources_zh_CN.java	1.4 05/09/01
 ...
 * </ol>
 *
 * @version @(#)TTYResources.java	1.13 04/02/09
 */
public class TTYResources_zh_CN extends java.util.ListResourceBundle {
    ...
    public Object[][] getContents() {
        ...
        {"Method entered:", "\u65b9\u6cd5\u5df2\u8f93\u5165\uff1a {0}.{1} "},
        {"Method exited:", "\u65b9\u6cd5\u5df2\u9000\u51fa\uff1a {0}.{1} "},
        ...
        {"Specify kind for example methods", "\u6307\u5b9a\u7c7b\u578b\uff0c\u4f8b\u5982\u201c\u65b9\u6cd5\u201d"},
        ...
        {"zz usage text",
             ...
             "                      \u67e5\u627e\u6e90\u6587\u4ef6\u7684\u76ee\u5f55\n" +
             "    -attach <\u5730\u5740>\n" +
             "                      \u4f7f\u7528\u6807\u51c6\u8fde\u63a5\u5668\u8fde\u63a5\u5230\u4f4d\u4e8e\u6307\u5b9a\u5730\u5740\u7684\u6b63\u5728\u8fd0\u884c\u7684 VM\n" +
             "    -listen <\u5730\u5740>\n" +
             "                      \u7b49\u5f85\u6b63\u5728\u8fd0\u884c\u7684 VM \u4f7f\u7528\u6807\u51c6\u8fde\u63a5\u5668\u5728\u6307\u5b9a\u5730\u5740\n" +
             "    -listenany\n" +
             "                      \u7b49\u5f85\u6b63\u5728\u8fd0\u884c\u7684 VM \u4f7f\u7528\u6807\u51c6\u8fde\u63a5\u5668\u5728\u4efb\u4f55\u53ef\u7528\u5730\u5740\u8fdb\u884c\u8fde\u63a5\n" +
             "    -launch\n" +
             "                      \u7acb\u5373\u542f\u52a8 VM\uff0c\u800c\u4e0d\u7b49\u5f85 \"run\" \u547d\u4ee4\n" +
             "    -listconnectors   \u5217\u51fa\u6b64 VM \u4e2d\u53ef\u7528\u7684\u8fde\u63a5\u5668\n" +
             "    -connect <\u8fde\u63a5\u5668\u540d\u79f0>:<\u540d\u79f0 1>=<\u503c 1>,...\n" +
             "                      \u4f7f\u7528\u6307\u5b9a\u8fde\u63a5\u5668\u548c\u5217\u51fa\u53c2\u6570\u503c\u8fde\u63a5\u5230\u76ee\u6807 VM\n" +
