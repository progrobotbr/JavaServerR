/*
 * @(#)ModificationWatchpointSpec.java	1.16 03/12/19
 *
...
class ModificationWatchpointSpec extends WatchpointSpec {
    ...
    ModificationWatchpointSpec(Environment pEnv, messageOutput pmsgout, ReferenceTypeSpec refSpec, String fieldId) 
