...
class EventRequestSpecList {
    ...
    EventRequestSpecList(Environment pEnv, messageOutput pmsgout) {
    	this.Env=pEnv;
    ...
    EventRequestSpec createBreakpoint(String classPattern, 
        ...
        ReferenceTypeSpec refSpec = 
            new PatternReferenceTypeSpec(this.Env, classPattern);
        return new BreakpointSpec(this.Env, this.MessageOutput, refSpec, line);
    }
    ...
    EventRequestSpec createBreakpoint(String classPattern, 
        ...
        ReferenceTypeSpec refSpec = 
            new PatternReferenceTypeSpec(this.Env, classPattern);
        return new BreakpointSpec(this.Env, this.MessageOutput, refSpec, methodId, methodArgs);
    }
    ...
    EventRequestSpec createExceptionCatch(String classPattern,
        ...
        return new ExceptionSpec(this.Env, this.MessageOutput, refSpec, notifyCaught, notifyUncaught);
    }
    ...
    EventRequestSpec createAccessWatchpoint(String classPattern, 
        ...
        ReferenceTypeSpec refSpec = 
            new PatternReferenceTypeSpec(Env, classPattern);
        return new AccessWatchpointSpec(Env, this.MessageOutput, refSpec, fieldId);
    }
    ...
    EventRequestSpec createModificationWatchpoint(String classPattern, 
        ...
        ReferenceTypeSpec refSpec = 
            new PatternReferenceTypeSpec(Env, classPattern);
        return new ModificationWatchpointSpec(Env, this.MessageOutput, refSpec, fieldId);
    }
