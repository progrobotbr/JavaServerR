...
public class EventHandler implements Runnable {
    ...
    EventHandler(Environment pEnv,  messageOutput pmsgout, EventNotifier notifier, boolean stopOnVMStart) {
    ...
    private void setCurrentThread(ThreadReference thread) {
        ...
        ThreadInfo.setCurrentThread(this.Env, this.MessageOutput, thread); 
    }
    ...
    private boolean threadDeathEvent(Event event) {
        ...
        ThreadInfo.removeThread(this.Env, this.MessageOutput, tee.thread());
        return false;
    }

    private boolean threadStartEvent(Event event) {
        ThreadStartEvent tse = (ThreadStartEvent)event;
        ThreadInfo.addThread(this.Env, this.MessageOutput, tse.thread());
